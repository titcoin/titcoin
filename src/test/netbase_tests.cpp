...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8698", "::ffff:127.0.0.1", 8698));
    BOOST_CHECK(TestSplitHost("[::]:8698", "::", 8698));
    BOOST_CHECK(TestSplitHost("::8698", "::8698", -1));
    BOOST_CHECK(TestSplitHost(":8698", "", 8698));
    BOOST_CHECK(TestSplitHost("[]:8698", "", 8698));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8698", "127.0.0.1:8698"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8698", "[::]:8698"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
