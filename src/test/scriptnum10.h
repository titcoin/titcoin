...
#ifndef TITCOIN_TEST_SCRIPTNUM10_H
#define TITCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Titcoin 0.10.0, for cross-comparison.
 */
public:
