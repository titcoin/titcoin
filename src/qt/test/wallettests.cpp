...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TitcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_titcoin-qt -platform xcb      # Linux
//     src/qt/test/test_titcoin-qt -platform windows  # Windows
//     src/qt/test/test_titcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = TitcoinUnits::formatWithUnit(unit, balance, false, TitcoinUnits::separatorAlways);
    ...
    // Amount input
    TitcoinAmountField* amountInput = receiveCoinsDialog.findChild<TitcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: titcoin:")) != -1);
