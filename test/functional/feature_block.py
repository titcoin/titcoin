...
This reimplements tests from the titcoinj/FullBlockTestGenerator used
by the pull-tester.
...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure titcoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure titcoind isn't accepting b28
        ...
        tip(57)
        b59 = block(59)
        tx = create_and_sign_tx(out[17].tx, out[17].n, 70*COIN)
        ...
        #    Low-S and High-S values (whereas the titcoin code has custom code which does so);
