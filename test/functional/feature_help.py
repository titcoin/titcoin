...
"""Verify that starting titcoin with -h works as expected."""
import subprocess

from test_framework.test_framework import TitcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(TitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start titcoin with -h for help text")
        ...
        self.log.info("Start titcoin with -version for version information")
