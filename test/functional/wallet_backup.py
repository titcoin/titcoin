...
Miner creates 100 blocks so 1 2 3 each have 69 mature
coins to spend.
...
class WalletBackupTest(TitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 114 are mature, so the sum of all wallets should be 114 * 69 = 7866.
        assert_equal(total, 7866)
