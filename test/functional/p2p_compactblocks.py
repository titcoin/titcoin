...
# TestNode: A peer we use to send messages to titcoind, and store responses.
...
class CompactBlocksTest(TitcoinTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-vbparams=segwit:0:0"], ["-vbparams=segwit:0:999999999999", "-rpcserialversion=1", "-txindex", "-deprecatedrpc=addwitnessaddress"]]
        self.utxos = []
    ...
    # This test actually causes titcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that titcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for titcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # titcoind will not send blocktxn responses for blocks whose height is
