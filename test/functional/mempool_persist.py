...
By default, titcoind will dump mempool on shutdown and
...
class MempoolPersistTest(TitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give titcoind a second to reload the mempool
        ...
        self.log.debug("Prevent titcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
